...
/** Styles */
import "../react/Calendar/styles/Calendar-grid.css";
		...
		<Calendar
			...
			customHeader={(props: CustomHeaderFooterRendererProps) => (
				<div style={CustomHeaderStyles}>
					<button onClick={props.handlePrevMonth} style={ButtonStyles}>
						<LeftArrow />
					</button>
					<div>
						{props.selectedMonth}/{props.selectedYear}
					</div>
					<button onClick={props.handleNextMonth} style={ButtonStyles}>
						<RightArrow />
					</button>
				</div>
			)}
